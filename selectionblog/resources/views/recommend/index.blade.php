...
<html lang="{{ str_replace('_', '-', app()->getlocale()) }}">
    ...
    <body>
        ...
        <header class="header">
            <div class="logo">
                {{--　ヘッダー内ロゴ画像　--}}
                <figure class="image"><img src="https://selectionblog.s3.us-east-2.amazonaws.com/%E3%83%AD%E3%82%B4%E6%96%87%E5%AD%97%E4%BB%98.png" width="250" height="50"></figure></div>
            <div class="nav">
